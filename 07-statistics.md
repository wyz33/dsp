...
>>To answer this question based on Bayesian stats, we have to first set up two mutually exclusive and collectivley exhausive hypotheses:
H1: Elvis is a fraternal twin (FT); 
H2: Evlis is a identical twin (IT); 
